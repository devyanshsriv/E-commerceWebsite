...
<body>
	<%-- <form class="form-horizontal" action="pay" method="POST">
		<fieldset>
			...
			<div class="form-group">
				<label class="col-md-4 control-label" for="textinput">Card
					Number:</label>
				<div class="col-md-5">
				...
				<div class="form-group">
					<label class="col-md-4 control-label" for="textinput">Expire
						Date:</label>
					<div class="col-md-5">
				...
				<div class="form-group">
					...
					<div class="form-group">
						<label class="col-md-4 control-label" for="textinput">Payble
							Amount:</label> Rs.${grandTotal}
					</div>
	...
	<form:form modelAttribute="shop"
		action="${pageContext.request.contextPath}/pay" method="POST"
		role="form">
						...
						<div class="row">
							<div class="col-50">
								...
								<form:input type="text" id="email" name="email"
									placeholder="john@example.com" path="email" />
								...
								<form:input type="text" id="city" name="city" placeholder="city"
									path="city" />

								<div class="row">
									<div class="col-50">
										<label for="zip">Pincode</label>
										<form:input type="text" id="pincode" name="pincode"
											placeholder="10001" path="pincode" />
									</div>
								</div>
							</div>
