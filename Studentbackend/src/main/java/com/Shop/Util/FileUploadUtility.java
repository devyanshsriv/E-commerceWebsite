...
public class FileUploadUtility {
	...
	private static String ABS_PATH = "C:\\Users\\giftland\\eclipse-workspace\\Website\\src\\main\\webapp\\resources\\Images\\";
	private static String REAL_PATH = null;

	public static boolean uploadFile(HttpServletRequest request, MultipartFile files[], String code) {
		ABS_PATH = "C:\\Users\\giftland\\eclipse-workspace\\Website\\src\\main\\webapp\\resources\\Images\\";
		// get the real server path
		REAL_PATH = request.getSession().getServletContext().getRealPath("/resources/Images/" + code + "/");
